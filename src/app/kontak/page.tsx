          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="rounded-3xl border border-zinc-200 bg-white p-5">
              <p className="text-sm font-semibold uppercase tracking-wide text-zinc-500">
                Kantor & Tempat Konsultasi
              </p>
              <p className="mt-1.5 text-xs leading-relaxed text-zinc-500">
                Kunjungi kami langsung untuk diskusi project, lihat contoh produk, dan konsultasi spesifikasi secara tatap muka.
              </p>
              ...
              <div className="mt-2 space-y-1.5 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-zinc-700">
                    Kantor: <span className="font-semibold">Senin–Sabtu, 08.00–17.00</span>
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-emerald-500 shrink-0" />
                  <span className="text-zinc-700">
                    Chat WA: <span className="font-semibold text-emerald-700">Setiap hari, 24 jam</span>
                  </span>
                </div>
              </div>
              <p className="mt-3 text-xs leading-relaxed text-zinc-500">
                Tidak perlu tunggu jam kerja — kirim pesan kapan saja, tim kami akan segera membalas.
              </p>
              <a
                href={waUrl("Halo admin PFS, saya ingin konsultasi")}
                target="_blank"
                rel="noopener noreferrer"
                className="mt-3 inline-flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-2 text-xs font-bold text-white transition hover:bg-[#20b558]"
              >
