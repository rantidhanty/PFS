      ...
      <div className="mx-auto flex h-14 w-full max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="hidden items-center gap-1.5 rounded-full bg-orange-500 px-4 py-2 text-xs font-bold text-white shadow-sm transition hover:bg-orange-600 sm:inline-flex"
          >
            <svg viewBox="0 0 24 24" fill="white" aria-hidden="true" className="h-3.5 w-3.5">
        ...
        <div className="border-t border-zinc-100 bg-white px-4 py-3 md:hidden">
          <nav className="flex flex-col gap-1">
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setIsOpen(false)}
              className="mt-1 inline-flex items-center gap-2 rounded-xl bg-orange-500 px-3 py-2.5 text-sm font-bold text-white"
            >
